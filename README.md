...
- [Litecore Lib](packages/litecore-lib) - A pure and powerful JavaScript Litecoin library
...
- [Litecore P2P](packages/litecore-p2p) - The peer-to-peer networking protocol for LTC
